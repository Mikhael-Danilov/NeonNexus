...
(async () => {
  ...
  // 01 — start screen
  await page.screenshot({ path: path.join(OUT, '01_start_screen.png'), clip: { x: 0, y: 0, width: 1920, height: 1080 } });
  console.log('01 ok');
  ...
  await page.screenshot({ path: path.join(OUT, '02_gameplay_early.png'), clip: { x: 0, y: 0, width: 1920, height: 1080 } });
  console.log('02 ok');
  ...
  await page.screenshot({ path: path.join(OUT, '03_combat.png'), clip: { x: 0, y: 0, width: 1920, height: 1080 } });
  console.log('03 ok');
  ...
  await page.screenshot({ path: path.join(OUT, '04_combat_late.png'), clip: { x: 0, y: 0, width: 1920, height: 1080 } });
  console.log('04 ok');
  ...
  await page.screenshot({ path: path.join(OUT, '05_game_over.png'), clip: { x: 0, y: 0, width: 1920, height: 1080 } });
  console.log('05 ok');
